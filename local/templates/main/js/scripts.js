(self["webpackChunkproject_start_template"] = self["webpackChunkproject_start_template"] || []).push([["/js/scripts"],{
...
var sameSlidersCreator = function sameSlidersCreator(elementsSelector) {
  if (elementsSelector == "") {
    return false;
  }
  ...
  _toConsumableArray(elements).forEach(function (element) {
    var sliderContainer = element.querySelector('.swiper-container');
    var sliderPagination = element.querySelector('.swiper-pagination');
    var sliderBtnNext = element.querySelector('.swiper-button-next');
    var sliderBtnPrev = element.querySelector('.swiper-button-prev');
    new swiper_core__WEBPACK_IMPORTED_MODULE_3__.default(sliderContainer, {
      // parameters
      watchOverflow: true,
      slidesPerView: 1,
      slidesPerGroup: 1,
...
var initCollapse = function initCollapse(control, target) {
...
var formValidator = {
  ...
  isTextFieldValid: function isTextFieldValid(textField) {
    return textField.val().length > 0;
  },
  isCheckboxValid: function isCheckboxValid(checkbox) {
    return checkbox.prop('checked');
  },
  validationField: function validationField(field, fieldName) {
    var isFieldValid = this.isTextFieldValid;
  ...
  validationForm: function validationForm() {
    if (this.validFields.length === this.fields.length && this.isCheckboxValid(this.formAgreement)) {
  ...
  init: function init() {
    ...
    this.form = jquery__WEBPACK_IMPORTED_MODULE_0___default()('[data-form="callback-form"]');
    ...
    this.fields.on('input', function (event) {
      _this.validationField(jquery__WEBPACK_IMPORTED_MODULE_0___default()(event.target), _this.getFieldName(jquery__WEBPACK_IMPORTED_MODULE_0___default()(event.target)));

      _this.validationForm();
    });
    this.formAgreement.on('input', this.validationForm.bind(this));
  }
};
var DESKTOP_SIZE = 1151;
var PAD_SIZE = 768;
...
window.addEventListener('DOMContentLoaded', function () {
  ...
  jquery__WEBPACK_IMPORTED_MODULE_0___default()(document).on('click', '[data-collapse="control"]', function () {
    ...
    var target = control.siblings('[data-collapse="target"]').slideToggle();
  ...
  jquery__WEBPACK_IMPORTED_MODULE_0___default()(document).on('click', '[data-show-full="control"]', function () {
    var $control = jquery__WEBPACK_IMPORTED_MODULE_0___default()(this);
    var $target = $control.siblings('[data-show-full="target"]');
...
/******/ __webpack_require__.O(0, ["css/styles","/js/vendor"], () => (__webpack_exec__("./src/js/scripts.js"), __webpack_exec__("./src/sass/styles.scss")));
